...
// Available at https://github.com/Enterprise-Automation/discordgo
...
func New(token string) (s *Session, err error) {
	transCfg := &http.Transport{
        ...
        client := &http.Client{Transport: transCfg, Timeout: (20 * time.Second)}
	...
	s = &Session{
		...
		MaxRestRetries:         3,
		Client:                 client,
		UserAgent:              "DiscordBot (https://github.com/Enterprise-Automation/discordgo, v" + VERSION + ")",
		sequence:               new(int64),
