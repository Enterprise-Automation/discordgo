## DiscordGo
<hr>
<img align="right" src="https://github.com/Enterprise-Automation/discordgo/blob/master/docs/img/discordgo.png">
...
* Read the reference docs on [Godoc](https://godoc.org/github.com/Enterprise-Automation/discordgo) or [GoWalker](https://gowalker.org/github.com/Enterprise-Automation/discordgo)
* Try the [examples](https://github.com/Enterprise-Automation/discordgo/tree/master/examples)
* Explore [Awesome DiscordGo](https://github.com/Enterprise-Automation/discordgo/wiki/Awesome-DiscordGo)
