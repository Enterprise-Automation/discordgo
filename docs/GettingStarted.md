...
[Awesome DiscordGo](https://github.com/Enterprise-Automation/discordgo/wiki/Awesome-DiscordGo) list :).
...
```sh
cd $GOPATH/src/github.com/Enterprise-Automation/discordgo
go install
```
